...
FOR %%x IN ("D:\GitHub\Six-Shooter-RP\Xampp\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\GitHub\Six-Shooter-RP\Xampp\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\GitHub\Six-Shooter-RP\Xampp\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\GitHub\Six-Shooter-RP\Xampp\php\php.exe"
GOTO :INSTALLED
